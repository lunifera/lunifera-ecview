...
public class OperationPersister extends AdapterImpl implements OperationRecorderListener {
	 ...
	 * 		The history file will be created at the same location, but the file ending will be <code>hist</code>. 
	 */
//	public OperationPersister(Resource resource) {
//		init(resource, resource.getURI().trimFileExtension().appendFileExtension("hist").toPlatformString(true));
//	}
