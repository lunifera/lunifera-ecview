 ...
 */
package org.eclipse.emf.ecp.ecview.ui.core.tests.editparts.emf.common;
...
import org.eclipse.emf.ecp.ecview.ui.core.editparts.emf.internal.OrphanViewsResource;
...
public class ResourceManagerTest {
	...
	public void test_getResource() {
		Resource r1_1 = ResourceManager.getInstance().getResource(CoreModelPackage.eNS_URI);
		Resource r1_2 = ResourceManager.getInstance().getResource(CoreModelPackage.eNS_URI);
		Assert.assertSame(r1_1, r1_2);

		Resource r2_1 = ResourceManager.getInstance().getResource(URI.createURI(CoreModelPackage.eNS_URI));
		Resource r2_2 = ResourceManager.getInstance().getResource(URI.createURI(CoreModelPackage.eNS_URI));
