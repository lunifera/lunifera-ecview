...
import org.eclipse.emf.ecp.ecview.ui.presentation.swt.internal.VerticalLayoutPresentation;
...
public class VerticalLayoutPresentationTest {
	...
	public void test_unrender_layout_and_render_byModel() throws Exception {
		...
		YVerticalLayout YVerticalLayout = factory.createVerticalLayout();
		yView.setContent(YVerticalLayout);
		YTextField yText1 = factory.createTextField();
		YVerticalLayout.getElements().add(yText1);
		YTextField yText2 = factory.createTextField();
		YVerticalLayout.getElements().add(yText2);

		ECViewSwtRenderer renderer = new ECViewSwtRenderer();
		renderer.render(shell, yView, null);

		// layout
		IVerticalLayoutEditpart layoutEditpart = DelegatingEditPartManager
				.getInstance().getEditpart(YVerticalLayout);
		...
		YVerticalLayout.getElements().remove(yText1);
		...
		// now set the verticallayout as the content -> Should be rendered
		// again
		yView.setContent(YVerticalLayout);
		// layout
		Assert.assertTrue(presLayout.isRendered());
	...
	public void test_orderOfChildren_remove_add() throws Exception {
		...
		YVerticalLayout.getElements().add(yText3);
	...
	public void test_orderOfChildren_insert() throws Exception {
		...
		//
		YTextField yText3 = factory.createTextField();
		YVerticalLayout.getElements().add(1, yText3);
	...
	public void test_orderOfChildren_insert_twice() throws Exception {
		...
		try {
			YVerticalLayout.getElements().add(0, yText2);
			Assert.fail();
			// BEGIN SUPRESS CATCH EXCEPTION
		} catch (Exception e) {
			// END SUPRESS CATCH EXCEPTION
	...
	public void test_orderOfChildren_move_inSameParent() throws Exception {
		...
		//
		YVerticalLayout.getElements().move(1, yText1);
	...
	public void test_orderOfChildren_move_toDifferentParent() throws Exception {
		...
		// .........> yText3
		YView yView = factory.createView();
		YVerticalLayout YVerticalLayout1 = factory.createVerticalLayout();
		yView.setContent(YVerticalLayout1);
		YTextField yText1 = factory.createTextField();
		YVerticalLayout1.getElements().add(yText1);
		YTextField yText2 = factory.createTextField();
		YVerticalLayout1.getElements().add(yText2);
		YTextField yText3 = factory.createTextField();
		YVerticalLayout1.getElements().add(yText3);

		// the target verticalLayout1_1
		YVerticalLayout YVerticalLayout1_1 = factory.createVerticalLayout();
		YVerticalLayout1.getElements().add(YVerticalLayout1_1);

		ECViewSwtRenderer renderer = new ECViewSwtRenderer();
		renderer.render(shell, yView, null);

		// layout
		IVerticalLayoutEditpart layoutEditpart1 = DelegatingEditPartManager
				.getInstance().getEditpart(YVerticalLayout1);
		ITextFieldEditpart text1Editpart = DelegatingEditPartManager
				.getInstance().getEditpart(yText1);
		ITextFieldEditpart text2Editpart = DelegatingEditPartManager
				.getInstance().getEditpart(yText2);
		ITextFieldEditpart text3Editpart = DelegatingEditPartManager
				.getInstance().getEditpart(yText3);
		IVerticalLayoutEditpart layoutEditpart1_1 = DelegatingEditPartManager
				.getInstance().getEditpart(YVerticalLayout1_1);
		...
		// move text1 for YVerticalLayout1 to YVerticalLayout1_1
		//
		YVerticalLayout1_1.getElements().add(yText1);
		Assert.assertEquals(presText2.getWidget(), composite.getChildren()[0]);
		Assert.assertEquals(presText3.getWidget(), composite.getChildren()[1]);
		Assert.assertEquals(presLayout1_1.getWidget(),
	...
	public void test_renderChildren_forceFalse() throws Exception {
		...
		YVerticalLayout.getElements().add(yText);
	...
	public void test_InternalStructure() throws Exception {
		...
		Assert.assertEquals(SWT.VERTICAL, cLayout.type);
	}
	...
	public void test_InternalStructure_2() throws Exception {
		...
		YView yView = factory.createView();
		YVerticalLayout yLayout = factory.createVerticalLayout();
		yLayout.setFillVertical(false); // applied to the row layout -> pack is
										// true
	...
	public void test_InternalStructure__CSS() throws Exception {
		...
		YVerticalLayout yLayout = factory.createVerticalLayout();
		yView.setContent(yLayout);
		YVerticalLayout yInternalLayout1 = factory.createVerticalLayout();
		yInternalLayout1.setCssID("ID_0815");
		yInternalLayout1.setCssClass("anyOtherClass");
		yLayout.addElement(yInternalLayout1);
		YVerticalLayout yInternalLayout2 = factory.createVerticalLayout();
		yLayout.addElement(yInternalLayout2);

		ECViewSwtRenderer renderer = new ECViewSwtRenderer();
		renderer.render(shell, yView, null);

		IVerticalLayoutEditpart internalLayout1Editpart = DelegatingEditPartManager
				.getInstance().getEditpart(yInternalLayout1);
		IVerticalLayoutEditpart internalLayout2Editpart = DelegatingEditPartManager
