 ...
 * <ul>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.common.model.core.impl.YEmbeddableImpl#getId
 * <em>Id</em>}</li>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.common.model.core.impl.YEmbeddableImpl#getCssClass
 * <em>Css Class</em>}</li>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.common.model.core.impl.YEmbeddableImpl#getCssID
 * <em>Css ID</em>}</li>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.common.model.core.impl.YEmbeddableImpl#isInitialVisible
 * <em>Initial Visible</em>}</li>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.common.model.core.impl.YEmbeddableImpl#isVisible
 * <em>Visible</em>}</li>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.common.model.core.impl.YEmbeddableImpl#getVisibilityProcessor
...
public abstract class YEmbeddableImpl extends MinimalEObjectImpl.Container
	...
	/**
	 * The default value of the '{@link #isInitialVisible()
	 * <em>Initial Visible</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #isInitialVisible()
	 * <em>Initial Visible</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #isInitialVisible()
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CoreModelPackage.YEMBEDDABLE__ID, oldId, id));
	}
	...
	public void setCssClass(String newCssClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CoreModelPackage.YEMBEDDABLE__CSS_CLASS, oldCssClass,
					cssClass));
	}
	...
	public void setCssID(String newCssID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CoreModelPackage.YEMBEDDABLE__CSS_ID, oldCssID, cssID));
	}
	...
	public void setInitialVisible(boolean newInitialVisible) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CoreModelPackage.YEMBEDDABLE__INITIAL_VISIBLE,
					oldInitialVisible, initialVisible));
	}
	...
	public void setVisible(boolean newVisible) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CoreModelPackage.YEMBEDDABLE__VISIBLE, oldVisible, visible));
	}
			...
			if (visibilityProcessor != oldVisibilityProcessor) {
				...
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CoreModelPackage.YEMBEDDABLE__VISIBILITY_PROCESSOR,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case CoreModelPackage.YEMBEDDABLE__VISIBILITY_PROCESSOR:
			if (visibilityProcessor != null)
				msgs = ((InternalEObject) visibilityProcessor)
						.eInverseRemove(
								this,
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == YVisibleable.class) {
			switch (derivedFeatureID) {
			case CoreModelPackage.YEMBEDDABLE__INITIAL_VISIBLE:
				return CoreModelPackage.YVISIBLEABLE__INITIAL_VISIBLE;
			case CoreModelPackage.YEMBEDDABLE__VISIBLE:
				return CoreModelPackage.YVISIBLEABLE__VISIBLE;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == YCssAble.class) {
			...
			case CoreModelPackage.YCSS_ABLE__CSS_CLASS:
				return CoreModelPackage.YEMBEDDABLE__CSS_CLASS;
			case CoreModelPackage.YCSS_ABLE__CSS_ID:
				return CoreModelPackage.YEMBEDDABLE__CSS_ID;
			default:
				return -1;
			}
		}
		if (baseClass == YVisibleable.class) {
			switch (baseFeatureID) {
			case CoreModelPackage.YVISIBLEABLE__INITIAL_VISIBLE:
				return CoreModelPackage.YEMBEDDABLE__INITIAL_VISIBLE;
			case CoreModelPackage.YVISIBLEABLE__VISIBLE:
				return CoreModelPackage.YEMBEDDABLE__VISIBLE;
			default:
				return -1;
			}
		}
		if (baseClass == YVisibilityProcessable.class) {
			...
			case CoreModelPackage.YVISIBILITY_PROCESSABLE__VISIBILITY_PROCESSOR:
				return CoreModelPackage.YEMBEDDABLE__VISIBILITY_PROCESSOR;
			default:
				return -1;
			}
		}
