 ...
 * <ul>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.common.model.binding.impl.YBindingImpl#getId
 * <em>Id</em>}</li>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.common.model.binding.impl.YBindingImpl#getTargetValue
 * <em>Target Value</em>}</li>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.common.model.binding.impl.YBindingImpl#getModelValue
 * <em>Model Value</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class YBindingImpl extends EObjectImpl implements YBinding {
	...
	/**
	 * The cached value of the '{@link #getTargetValue() <em>Target Value</em>}'
	...
	/**
	 * The cached value of the '{@link #getModelValue() <em>Model Value</em>}'
	 * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getModelValue()
	 * @generated
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTargetValue(
			YBindingEndpoint newTargetValue, NotificationChain msgs) {
		YBindingEndpoint oldTargetValue = targetValue;
		targetValue = newTargetValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, BindingPackage.YBINDING__TARGET_VALUE,
	...
	public void setTargetValue(YBindingEndpoint newTargetValue) {
		if (newTargetValue != targetValue) {
			...
			if (targetValue != null)
				msgs = ((InternalEObject) targetValue).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- BindingPackage.YBINDING__TARGET_VALUE, null,
						msgs);
			if (newTargetValue != null)
				msgs = ((InternalEObject) newTargetValue).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- BindingPackage.YBINDING__TARGET_VALUE, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					BindingPackage.YBINDING__TARGET_VALUE, newTargetValue,
					newTargetValue));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetModelValue(YBindingEndpoint newModelValue,
			NotificationChain msgs) {
		YBindingEndpoint oldModelValue = modelValue;
		modelValue = newModelValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, BindingPackage.YBINDING__MODEL_VALUE,
	...
	public void setModelValue(YBindingEndpoint newModelValue) {
		if (newModelValue != modelValue) {
			NotificationChain msgs = null;
			if (modelValue != null)
				msgs = ((InternalEObject) modelValue).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- BindingPackage.YBINDING__MODEL_VALUE, null,
						msgs);
			if (newModelValue != null)
				msgs = ((InternalEObject) newModelValue).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- BindingPackage.YBINDING__MODEL_VALUE, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					BindingPackage.YBINDING__MODEL_VALUE, newModelValue,
					newModelValue));
	}
	...
	public boolean isBindsElement(YElement element) {
		return getModelValue() != null
				&& getModelValue().isBindsElement(element)
				|| getTargetValue() != null
				&& getTargetValue().isBindsElement(element);
