 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.ecp.ecview.ui.core.model.extension.impl.YCheckBoxImpl#getValueBindingURIString <em>Value Binding URI String</em>}</li>
 *   <li>{@link org.eclipse.emf.ecp.ecview.ui.core.model.extension.impl.YCheckBoxImpl#getDatadescription <em>Datadescription</em>}</li>
 *   <li>{@link org.eclipse.emf.ecp.ecview.ui.core.model.extension.impl.YCheckBoxImpl#getDatatype <em>Datatype</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class YCheckBoxImpl extends YInputImpl implements YCheckBox {
	...
	public void setValueBindingURIString(String newValueBindingURIString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtensionModelPackage.YCHECK_BOX__VALUE_BINDING_URI_STRING, oldValueBindingURIString, valueBindingURIString));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExtensionModelPackage.YCHECK_BOX__VALUE_BINDING_URI_STRING:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == YBindable.class) {
			switch (derivedFeatureID) {
				case ExtensionModelPackage.YCHECK_BOX__VALUE_BINDING_URI_STRING: return CoreModelPackage.YBINDABLE__VALUE_BINDING_URI_STRING;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == YBindable.class) {
			switch (baseFeatureID) {
				case CoreModelPackage.YBINDABLE__VALUE_BINDING_URI_STRING: return ExtensionModelPackage.YCHECK_BOX__VALUE_BINDING_URI_STRING;
				default: return -1;
			}
		}
