...
public class YOptionsGroupDataTypeImpl extends EObjectImpl implements YOptionsGroupDataType {
	...
	public EList<org.eclipse.emf.ecp.ecview.common.model.validation.YValidator> getValidators() {
		if (validators == null) {
			validators = new EObjectResolvingEList<org.eclipse.emf.ecp.ecview.common.model.validation.YValidator>(org.eclipse.emf.ecp.ecview.common.model.validation.YValidator.class, this, ExtDatatypesPackage.YOPTIONS_GROUP_DATA_TYPE__VALIDATORS);
		}
		return validators;
	}
