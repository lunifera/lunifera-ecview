...
public class YComboBoxDatatypeImpl extends EObjectImpl implements YComboBoxDatatype {
	...
	public EList<org.eclipse.emf.ecp.ecview.common.model.validation.YValidator> getValidators() {
		if (validators == null) {
			validators = new EObjectResolvingEList<org.eclipse.emf.ecp.ecview.common.model.validation.YValidator>(org.eclipse.emf.ecp.ecview.common.model.validation.YValidator.class, this, ExtDatatypesPackage.YCOMBO_BOX_DATATYPE__VALIDATORS);
		}
		return validators;
	}
