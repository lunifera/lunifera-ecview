 ...
 * <ul>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.extension.model.extension.impl.YFormLayoutImpl#isSpacing
 * <em>Spacing</em>}</li>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.extension.model.extension.impl.YFormLayoutImpl#isMargin
 * <em>Margin</em>}</li>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.extension.model.extension.impl.YFormLayoutImpl#getCellStyles
 * <em>Cell Styles</em>}</li>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.extension.model.extension.impl.YFormLayoutImpl#isFillVertical
...
public class YFormLayoutImpl extends YLayoutImpl implements YFormLayout {
	...
	public void setSpacing(boolean newSpacing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExtensionModelPackage.YFORM_LAYOUT__SPACING, oldSpacing,
					spacing));
	}
	...
	public void setMargin(boolean newMargin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExtensionModelPackage.YFORM_LAYOUT__MARGIN, oldMargin,
					margin));
	}
	...
	public EList<YFormLayoutCellStyle> getCellStyles() {
		if (cellStyles == null) {
			cellStyles = new EObjectContainmentEList.Resolving<YFormLayoutCellStyle>(
					YFormLayoutCellStyle.class, this,
					ExtensionModelPackage.YFORM_LAYOUT__CELL_STYLES);
		}
		return cellStyles;
	}
	...
	public void setFillVertical(boolean newFillVertical) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExtensionModelPackage.YFORM_LAYOUT__FILL_VERTICAL,
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ExtensionModelPackage.YFORM_LAYOUT__CELL_STYLES:
			...
			getCellStyles().addAll(
					(Collection<? extends YFormLayoutCellStyle>) newValue);
			return;
		case ExtensionModelPackage.YFORM_LAYOUT__FILL_VERTICAL:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == YSpacingable.class) {
			...
			case CoreModelPackage.YSPACINGABLE__SPACING:
				return ExtensionModelPackage.YFORM_LAYOUT__SPACING;
			default:
				return -1;
			}
		}
		if (baseClass == YMarginable.class) {
			...
			case CoreModelPackage.YMARGINABLE__MARGIN:
				return ExtensionModelPackage.YFORM_LAYOUT__MARGIN;
			default:
				return -1;
			}
		}
