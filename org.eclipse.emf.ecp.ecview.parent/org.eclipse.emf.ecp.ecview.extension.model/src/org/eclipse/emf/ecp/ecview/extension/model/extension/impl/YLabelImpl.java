...
public class YLabelImpl extends YFieldImpl implements YLabel {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == YValueBindable.class) {
			switch (baseOperationID) {
				case CoreModelPackage.YVALUE_BINDABLE___CREATE_VALUE_ENDPOINT: return ExtensionModelPackage.YLABEL___CREATE_VALUE_ENDPOINT;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ExtensionModelPackage.YLABEL___CREATE_VALUE_ENDPOINT:
