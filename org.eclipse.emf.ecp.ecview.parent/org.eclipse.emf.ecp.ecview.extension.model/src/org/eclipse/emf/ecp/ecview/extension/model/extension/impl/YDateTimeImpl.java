 ...
 * <ul>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.extension.model.extension.impl.YDateTimeImpl#getDatatype
 * <em>Datatype</em>}</li>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.extension.model.extension.impl.YDateTimeImpl#getDatadescription
 * <em>Datadescription</em>}</li>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.extension.model.extension.impl.YDateTimeImpl#getValue
 * <em>Value</em>}</li>
 * </ul>
 * </p>
 * 
...
public class YDateTimeImpl extends YInputImpl implements YDateTime {
			...
			if (datatype != oldDatatype) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ExtensionModelPackage.YDATE_TIME__DATATYPE,
	...
	public void setDatatype(YDateTimeDatatype newDatatype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExtensionModelPackage.YDATE_TIME__DATATYPE, oldDatatype,
					datatype));
	}
	...
	public YDatadescription getDatadescription() {
		if (datadescription != null && ((EObject) datadescription).eIsProxy()) {
			...
			if (datadescription != oldDatadescription) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ExtensionModelPackage.YDATE_TIME__DATADESCRIPTION,
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExtensionModelPackage.YDATE_TIME__VALUE, oldValue, value));
	}
