...
public class YTextFieldImpl extends YInputImpl implements YTextField {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == YValueBindable.class) {
			switch (baseOperationID) {
				case CoreModelPackage.YVALUE_BINDABLE___CREATE_VALUE_ENDPOINT: return ExtensionModelPackage.YTEXT_FIELD___CREATE_VALUE_ENDPOINT;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ExtensionModelPackage.YTEXT_FIELD___CREATE_VALUE_ENDPOINT:
