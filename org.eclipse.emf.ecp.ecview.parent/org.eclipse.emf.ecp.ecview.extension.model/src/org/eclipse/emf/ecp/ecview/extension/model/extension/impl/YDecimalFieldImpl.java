...
public class YDecimalFieldImpl extends YInputImpl implements YDecimalField {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == YValueBindable.class) {
			switch (baseOperationID) {
				case CoreModelPackage.YVALUE_BINDABLE___CREATE_VALUE_ENDPOINT: return ExtensionModelPackage.YDECIMAL_FIELD___CREATE_VALUE_ENDPOINT;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ExtensionModelPackage.YDECIMAL_FIELD___CREATE_VALUE_ENDPOINT:
