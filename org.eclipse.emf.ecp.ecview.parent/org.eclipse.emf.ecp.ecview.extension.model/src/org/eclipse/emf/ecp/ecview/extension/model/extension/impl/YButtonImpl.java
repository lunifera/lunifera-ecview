 ...
 * <ul>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.extension.model.extension.impl.YButtonImpl#isInitialEditable
 * <em>Initial Editable</em>}</li>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.extension.model.extension.impl.YButtonImpl#isEditable
 * <em>Editable</em>}</li>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.extension.model.extension.impl.YButtonImpl#getDatadescription
 * <em>Datadescription</em>}</li>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.extension.model.extension.impl.YButtonImpl#getClickListeners
 * <em>Click Listeners</em>}</li>
 * <li>
 * {@link org.eclipse.emf.ecp.ecview.extension.model.extension.impl.YButtonImpl#getLastClickTime
...
public class YButtonImpl extends YActionImpl implements YButton {
	...
	/**
	 * The cached value of the '{@link #getClickListeners()
	 * <em>Click Listeners</em>}' attribute list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The default value of the '{@link #getLastClickTime()
	...
	/**
	 * The cached value of the '{@link #getLastClickTime()
	 * <em>Last Click Time</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getLastClickTime()
	...
	public void setInitialEditable(boolean newInitialEditable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExtensionModelPackage.YBUTTON__INITIAL_EDITABLE,
	...
	public void setEditable(boolean newEditable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExtensionModelPackage.YBUTTON__EDITABLE, oldEditable,
					editable));
	}
			...
			if (datadescription != oldDatadescription) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ExtensionModelPackage.YBUTTON__DATADESCRIPTION,
	...
	public EList<YButtonClickListener> getClickListeners() {
		if (clickListeners == null) {
			clickListeners = new EDataTypeUniqueEList<YButtonClickListener>(
					YButtonClickListener.class, this,
					ExtensionModelPackage.YBUTTON__CLICK_LISTENERS);
		}
	...
	public void setLastClickTime(long newLastClickTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExtensionModelPackage.YBUTTON__LAST_CLICK_TIME,
					oldLastClickTime, lastClickTime));
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ExtensionModelPackage.YBUTTON__CLICK_LISTENERS:
			...
			getClickListeners().addAll(
					(Collection<? extends YButtonClickListener>) newValue);
			return;
		case ExtensionModelPackage.YBUTTON__LAST_CLICK_TIME:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == YEditable.class) {
			...
			case CoreModelPackage.YEDITABLE__INITIAL_EDITABLE:
				return ExtensionModelPackage.YBUTTON__INITIAL_EDITABLE;
			case CoreModelPackage.YEDITABLE__EDITABLE:
				return ExtensionModelPackage.YBUTTON__EDITABLE;
			default:
				return -1;
			}
		}
