 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.ecp.ui.model.core.uimodel.extension.impl.YUiCheckBoxImpl#getValueBindingURIString <em>Value Binding URI String</em>}</li>
...
public class YUiCheckBoxImpl extends YUiInputImpl implements YUiCheckBox {
	...
	public void setValueBindingURIString(String newValueBindingURIString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimodelExtensionPackage.YUI_CHECK_BOX__VALUE_BINDING_URI_STRING, oldValueBindingURIString, valueBindingURIString));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UimodelExtensionPackage.YUI_CHECK_BOX__VALUE_BINDING_URI_STRING:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == YUiBindable.class) {
			switch (derivedFeatureID) {
				case UimodelExtensionPackage.YUI_CHECK_BOX__VALUE_BINDING_URI_STRING: return UiModelPackage.YUI_BINDABLE__VALUE_BINDING_URI_STRING;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == YUiBindable.class) {
			switch (baseFeatureID) {
				case UiModelPackage.YUI_BINDABLE__VALUE_BINDING_URI_STRING: return UimodelExtensionPackage.YUI_CHECK_BOX__VALUE_BINDING_URI_STRING;
				default: return -1;
			}
		}
