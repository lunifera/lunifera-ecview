 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.ecp.ui.model.core.uimodel.extension.impl.YUiVerticalLayoutImpl#isSpacing <em>Spacing</em>}</li>
 *   <li>{@link org.eclipse.emf.ecp.ui.model.core.uimodel.extension.impl.YUiVerticalLayoutImpl#isMargin <em>Margin</em>}</li>
 *   <li>{@link org.eclipse.emf.ecp.ui.model.core.uimodel.extension.impl.YUiVerticalLayoutImpl#getCellStyles <em>Cell Styles</em>}</li>
 *   <li>{@link org.eclipse.emf.ecp.ui.model.core.uimodel.extension.impl.YUiVerticalLayoutImpl#isFillVertical <em>Fill Vertical</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class YUiVerticalLayoutImpl extends YUiLayoutImpl implements YUiVerticalLayout {
	/**
	 ...
	 * @ordered
	 */
	protected EList<YUiVerticalLayoutCellStyle> cellStyles;
	 ...
	 * @generated
	 */
	protected YUiVerticalLayoutImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return UimodelExtensionPackage.Literals.YUI_VERTICAL_LAYOUT;
	}
	...
	public void setSpacing(boolean newSpacing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimodelExtensionPackage.YUI_VERTICAL_LAYOUT__SPACING, oldSpacing, spacing));
	}
	...
	public void setMargin(boolean newMargin) {
		...
		margin = newMargin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimodelExtensionPackage.YUI_VERTICAL_LAYOUT__MARGIN, oldMargin, margin));
	}
	...
	public EList<YUiVerticalLayoutCellStyle> getCellStyles() {
		if (cellStyles == null) {
			cellStyles = new EObjectContainmentEList<YUiVerticalLayoutCellStyle>(YUiVerticalLayoutCellStyle.class, this, UimodelExtensionPackage.YUI_VERTICAL_LAYOUT__CELL_STYLES);
		}
		return cellStyles;
	}
	...
	public void setFillVertical(boolean newFillVertical) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimodelExtensionPackage.YUI_VERTICAL_LAYOUT__FILL_VERTICAL, oldFillVertical, fillVertical));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UimodelExtensionPackage.YUI_VERTICAL_LAYOUT__CELL_STYLES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UimodelExtensionPackage.YUI_VERTICAL_LAYOUT__SPACING:
				return isSpacing();
			case UimodelExtensionPackage.YUI_VERTICAL_LAYOUT__MARGIN:
				return isMargin();
			case UimodelExtensionPackage.YUI_VERTICAL_LAYOUT__CELL_STYLES:
				return getCellStyles();
			case UimodelExtensionPackage.YUI_VERTICAL_LAYOUT__FILL_VERTICAL:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case UimodelExtensionPackage.YUI_VERTICAL_LAYOUT__CELL_STYLES:
				getCellStyles().clear();
				getCellStyles().addAll((Collection<? extends YUiVerticalLayoutCellStyle>)newValue);
				return;
			case UimodelExtensionPackage.YUI_VERTICAL_LAYOUT__FILL_VERTICAL:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == YUiSpacingable.class) {
			switch (derivedFeatureID) {
				case UimodelExtensionPackage.YUI_VERTICAL_LAYOUT__SPACING: return UiModelPackage.YUI_SPACINGABLE__SPACING;
				default: return -1;
			}
		}
		if (baseClass == YUiMarginable.class) {
			switch (derivedFeatureID) {
				case UimodelExtensionPackage.YUI_VERTICAL_LAYOUT__MARGIN: return UiModelPackage.YUI_MARGINABLE__MARGIN;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == YUiSpacingable.class) {
			switch (baseFeatureID) {
				case UiModelPackage.YUI_SPACINGABLE__SPACING: return UimodelExtensionPackage.YUI_VERTICAL_LAYOUT__SPACING;
				default: return -1;
			}
		}
		if (baseClass == YUiMarginable.class) {
			switch (baseFeatureID) {
				case UiModelPackage.YUI_MARGINABLE__MARGIN: return UimodelExtensionPackage.YUI_VERTICAL_LAYOUT__MARGIN;
				default: return -1;
			}
		}
