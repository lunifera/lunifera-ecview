 ...
 */
public class UiTextAreaEditpart extends UiFieldEditpart<YUiTextArea> implements
		IUiTextAreaEditpart {

	@Override
	protected YUiTextArea createModel() {
		return (YUiTextArea) UimodelExtensionFactory.eINSTANCE
				.createYUiTextArea();
	}
