 ...
 * <ul>
 * <li>
 * {@link org.lunifera.ecview.core.extension.model.extension.impl.YAddToTableCommandImpl#getId
 * <em>Id</em>}</li>
 * <li>
 * {@link org.lunifera.ecview.core.extension.model.extension.impl.YAddToTableCommandImpl#getName
 * <em>Name</em>}</li>
 * <li>
 * {@link org.lunifera.ecview.core.extension.model.extension.impl.YAddToTableCommandImpl#getTable
 * <em>Table</em>}</li>
 * <li>
 * {@link org.lunifera.ecview.core.extension.model.extension.impl.YAddToTableCommandImpl#getTrigger
 * <em>Trigger</em>}</li>
 * </ul>
 * </p>
 *
...
public class YAddToTableCommandImpl extends MinimalEObjectImpl.Container
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExtensionModelPackage.YADD_TO_TABLE_COMMAND__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExtensionModelPackage.YADD_TO_TABLE_COMMAND__NAME, oldName,
					name));
	}
			...
			if (table != oldTable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ExtensionModelPackage.YADD_TO_TABLE_COMMAND__TABLE,
							oldTable, table));
			}
		}
		return table;
	...
	public void setTrigger(Object newTrigger) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExtensionModelPackage.YADD_TO_TABLE_COMMAND__TRIGGER,
					oldTrigger, trigger));
	}
