 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.ecp.ui.model.core.uimodel.extension.impl.YUiSpanInfoImpl#getColumnFrom <em>Column From</em>}</li>
 *   <li>{@link org.eclipse.emf.ecp.ui.model.core.uimodel.extension.impl.YUiSpanInfoImpl#getRowFrom <em>Row From</em>}</li>
 *   <li>{@link org.eclipse.emf.ecp.ui.model.core.uimodel.extension.impl.YUiSpanInfoImpl#getColumnTo <em>Column To</em>}</li>
 *   <li>{@link org.eclipse.emf.ecp.ui.model.core.uimodel.extension.impl.YUiSpanInfoImpl#getRowTo <em>Row To</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class YUiSpanInfoImpl extends EObjectImpl implements YUiSpanInfo {
	/**
	...
	protected EClass eStaticClass() {
		return UimodelExtensionPackage.Literals.YUI_SPAN_INFO;
	}
	...
	public void setColumnFrom(int newColumnFrom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimodelExtensionPackage.YUI_SPAN_INFO__COLUMN_FROM, oldColumnFrom, columnFrom));
	}
	...
	public void setRowFrom(int newRowFrom) {
		...
		rowFrom = newRowFrom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimodelExtensionPackage.YUI_SPAN_INFO__ROW_FROM, oldRowFrom, rowFrom));
	}
	...
	public void setColumnTo(int newColumnTo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimodelExtensionPackage.YUI_SPAN_INFO__COLUMN_TO, oldColumnTo, columnTo));
	}
	...
	public void setRowTo(int newRowTo) {
		...
		rowTo = newRowTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimodelExtensionPackage.YUI_SPAN_INFO__ROW_TO, oldRowTo, rowTo));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UimodelExtensionPackage.YUI_SPAN_INFO__COLUMN_FROM:
				return getColumnFrom();
			case UimodelExtensionPackage.YUI_SPAN_INFO__ROW_FROM:
				return getRowFrom();
			case UimodelExtensionPackage.YUI_SPAN_INFO__COLUMN_TO:
				return getColumnTo();
			case UimodelExtensionPackage.YUI_SPAN_INFO__ROW_TO:
				return getRowTo();
		}
